...
def _master(path,
    ...
    print('Saving _locs ...')
    info_locs=info.copy()
    info_locs=info_locs+[{'Box Size':box,'Generated by':'localize_undrift.py','Min. Net Gradient': mng}]
    ...
    info_locs_render=info_locs_render+[{'Segmentation':segments,'Generated by':'localize_undrift.py'}]
    ...
    info_props=info_props+[{'Generated by':'pickprops_filter.py',
                            'ignore':ignore,
                            'kin_filter': True,
