...
############################################# Load raw data
dir_names=[]
dir_names.extend(['/fs/pool/pool-schwille-paint/Data/p17.lbFCS2/21-04-08_origami-checks/01_s1_5000pM_p30uW_exp400_1'])


file_names=[]
file_names.extend(['01_s1_5000pM_p30uW_exp400_1_MMStack_Pos0.ome_locs_render_picked.hdf5'])
